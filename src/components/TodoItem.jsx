...
const TodoItem = ({ todo, updateTodo, deleteTodo }) => {
  ...
  return (
    <article className="flex items-center gap-4 py-4 px-4 border-b border-b-gray-400">
      <button
      ...
      <p className={`grow dark:text-gray-400 text-gray-600 font-semibold ${completed && "line-through font-normal"}`}>{title}</p>
